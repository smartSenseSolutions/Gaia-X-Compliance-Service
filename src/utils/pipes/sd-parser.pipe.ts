...
import { AddressDto, CredentialSubjectDto, SignedSelfDescriptionDto, VerifiableSelfDescriptionDto } from '../../@types/dto/common'
import { SelfDescriptionTypes } from '../../@types/enums'
import { getTypeFromSelfDescription } from '../methods'
